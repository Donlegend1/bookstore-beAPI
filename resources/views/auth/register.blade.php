					...
					<div class="col-md-6">
						<div class="login_innre">
							<form id="register" method="POST" action="{{ route('register') }}">
								...
								<p class="desc">If you already have an account, you can <a class="dec main" href="/login">Login here!</a></p>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="wow_form_fields mt-0">
											...
											<input id="confirm_password" type="password" placeholder="Confirm Password" name="password_confirmation"
								...
								<div class="form-group" style="margin-top:10px;">
									<div class="g-recaptcha" data-sitekey="6LdPKSEbAAAAAMbqPMtekUiHaSImGImKFwJ95soU"></div>
								</div>
								<div class="terms">
									<input type="checkbox" name="accept_terms" id="accept_terms" onchange="activateButton(this)">
									<label for="accept_terms">
										By creating your account you agree <a href="#" class="main">Terms of Use
										</a> & <a href="#" class="main">Privacy Policy</a>
									</label>
									<div class="clear"></div>
								</div>
								<div class="login_signup_combo">
									<div class="login__">
										<button type="submit" class="btn btn-main btn-mat add_wow_loader" id="sign_submit" disabled>Sign
											Up</button>
									</div>
								</div>
							</form>
							...
							<div class="footer">
								<div class="welcome-footer">
									<div>
										&copy; {{ now()->year }} BOONBAC &nbsp;•&nbsp;<a data-ajax="?link1=terms&type=terms" href="#">Terms
											of Use </a>
										&nbsp;•&nbsp;<a data-ajax="?link1=terms&type=privacy-policy" href="terms/privacy-policy.html">Privacy Policy
										</a>
										&nbsp;•&nbsp;<a data-ajax="?link1=contact-us" href="#"> Contact Us </a>
										&nbsp;•&nbsp;<a data-ajax="?link1=terms&type=about-us" href="#">About</a>
										&nbsp;•&nbsp;<a href="#">Blog</a>
										&nbsp;•&nbsp;<a href="#" data-ajax="?link1=forum"> Forum</a>
									</div>
									<div>
										<span class="lang">
